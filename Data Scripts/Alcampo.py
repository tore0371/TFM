...
if response.status_code != 200:
    ...
    for product in products:
        ...
        price_per_kilo_tag = product.find('span', class_='_text_f6lbl_1 _text--m_f6lbl_23 standard-promotion__PromotionIntentText-sc-1vpsrpe-2 price-per-unit__TruncatedText-sc-bnzhts-0 ksAbhD jsvUEM')
